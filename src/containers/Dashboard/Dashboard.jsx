...
import { Loader,DashboardComponent, Header} from '../../components'
...
function Dashboard() {
  ...
  return (
    <div className='dashboard-overall-container'>
      <Header/>
      <h1 className='goodmorni'>{greeting}</h1>
      <h2 className='username'>{username} !</h2>
      <Link className = 'search-box' to = "/search">
          <div className = "search-btn">
            <i className ="fas fa-search"></i>
          </div>
          <input className = "search-text" type="text" placeholder = "Search Product" />
      </Link>
      <DashboardComponent/>
      <div className='navbar-container'>
      <Link to="/dashboard">
        
        <svg className="mySvg"  id="dashboard-svg" width="27" height="27" viewBox="0 0 27 27" fill="#7519EB" xmlns="http://www.w3.org/2000/svg" >
