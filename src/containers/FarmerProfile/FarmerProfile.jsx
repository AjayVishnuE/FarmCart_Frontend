        ...
        <div className='Profile-overall-component'>
            ...
            <div className='profile-container-farmer'>
                ...
                <div className='farmerseccontainer'>
                    <Link to ='/farmeradddetails'>
                        <div className='farmdetailsbtn'>
                            Add/ Edit Your Farm Details.<br/><lable style={{"fontSize":"small"}}></lable>
                        </div>
                    </Link>
                    <div className='flexdivfarmprofile'>
                        <div className='btninprofile'>
                            <svg className='svgclass' xmlns="http://www.w3.org/2000/svg" width="30" height="32" viewBox="0 0 44 41" fill="none">
                        ...
                        <div className='btninprofile'>
                            <svg className='svgclass' xmlns="http://www.w3.org/2000/svg" width="28" height="23" viewBox="0 0 35 29" fill="none">
                ...
                <div className='recentorderviewallcontainer'>
                    ...
                    <Link className='viewname45' to="/farmerorders">view all</Link>
                </div>
